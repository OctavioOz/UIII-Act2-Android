          ...
          child: Column(
            children: [
              ...
              Column(
                ...
                children: [
                  const Text(
                    'Un corte muy casual para cualquier ocacion',
                    style: TextStyle(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            color: Color.fromARGB(255, 63, 111, 150),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(4),
                          decoration: const BoxDecoration(
                            color: Color.fromARGB(255, 72, 136, 209),
                            shape: BoxShape.circle,
                          ),
                          child: const Icon(
                            Icons.add,
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 63, 91, 150),
