          ...
          Center(
            child: Stack(
              children: [
                const Icon(
                  Icons.shopping_cart,
                  color: Color.fromARGB(255, 130, 122, 252),
                ),
                Positioned(
                  right: 3,
                  top: 0,
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                        color: Color.fromARGB(255, 58, 95, 130), shape: BoxShape.circle),
                  ),
                )
              ],
            ),
          ...
          Positioned(
            ...
            child: ClipPath(
              ...
              child: Container(
                height: 280,
                width: MediaQuery.of(context).size.width,
                color: const Color.fromARGB(255, 48, 69, 94),
                child: Row(
          ...
          Positioned(
            ...
            child: ClipPath(
              ...
              child: Container(
                ...
                width: MediaQuery.of(context).size.width,
                color: const Color.fromARGB(255, 63, 101, 150),
              ),
            ),
          ),
          Positioned(
